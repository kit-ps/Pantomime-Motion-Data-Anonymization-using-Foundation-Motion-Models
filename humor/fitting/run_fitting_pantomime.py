...
def main(tmp):
    args, config_file, split_size, split_part = tmp
    res_out_path = None
    ...
    if args.data_type == 'AMASS':
        ...
        data_fps = 30
    elif args.data_type == "CeTI":
        dataset = CeTIFitDataset(args.data_path,
                                 seq_len=60,
                                 return_joints=args.amass_use_joints,
                                 return_points=args.amass_use_points,
                                 return_rotations=args.amass_use_pose_body,
                                 split_size=split_size,
                                 split_part=split_part)
        data_fps = 30
    elif args.data_type == "Horst":
        dataset = HorstFitDataset(args.data_path,
                                 return_joints=args.amass_use_joints,
                                 return_points=args.amass_use_points,
                                 split_size=split_size,
                                 split_part=split_part)
    ...
    loss_weights = {
        ...
        'pose_body': args.pose_body_weight,
